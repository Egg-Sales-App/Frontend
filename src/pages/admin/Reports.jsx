...
const Reports = () => {
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col gap-6 w-1/2">
           <section className="w-[555px] bg-white rounded-lg p-6 shadow mt-2">
  <h2 className="text-lg font-bold text-gray-800 mb-6">Overview</h2>

  {/* Top stats row */}
  <div className="flex justify-between mb-6">
    <div className="flex flex-col items-start">
      <span className="text-lg font-medium text-gray-600">GHS 21,190</span>
      <span className="text-sm text-gray-500">Total Profit</span>
    </div>
    <div className="flex flex-col items-start">
      <span className="text-lg font-medium text-gray-600">GHS 18,300</span>
      <span className="text-sm text-yellow-600">Revenue</span>
    </div>
    <div className="flex flex-col items-start">
      <span className="text-lg font-medium text-gray-600">GHS 17,432</span>
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
    <div>
      <span className="block text-base font-medium text-gray-600">GHS 117,432</span>
      <span className="text-sm text-gray-500">Net purchase value</span>
    </div>
    <div>
      <span className="block text-base font-medium text-gray-600">GHS 80,432</span>
      <span className="text-sm text-gray-500">Net sales value</span>
    </div>
    <div>
      <span className="block text-base font-medium text-gray-600">GHS 30,432</span>
      <span className="text-sm text-gray-500">MoM Profit</span>
    </div>
    <div>
      <span className="block text-base font-medium text-gray-600">GHS 110,432</span>
      <span className="text-sm text-gray-500">YoY Profit</span>
          ...
          {/* Right Column */}
          <div className="flex flex-col gap-6 w-1/2">
           <section className="w-[520px] bg-white rounded-lg p-4 shadow relative mt-2">
  <div className="flex justify-between items-center mb-4">
    <h2 className="text-lg font-bold text-gray-800">Best Selling Category</h2>
